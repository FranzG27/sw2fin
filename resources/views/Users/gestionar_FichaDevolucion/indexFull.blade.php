...
@endif
<div class="" >
    <h3>Todas las Fichas de Devolucion</h3>
            ...
            <tbody>
                ...
                @foreach ($filesReturn as $fileReturn)
                    <tr>
                        ...
                        <th>
                            <a href="{{route('users.returnFile.editarView',$fileReturn->id)}}" class="btn btn-square btn-warning m-2">
