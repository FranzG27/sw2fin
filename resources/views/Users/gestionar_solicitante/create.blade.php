...
<div class="bg-secondary rounded h-100 p-4">
    <form method="POST" action="{{route('users.applicant.crear')}}">
        @csrf
        @method('POST')
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="inputEmail3" name="ci">
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="date" class="form-control" id="inputEmail3" name="birthdate">
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="inputEmail3" name="cellphone">
            </div>
        </div>
