...
<h1>Editar Inventario de Sangre</h1>
<div class="bg-secondary rounded h-100 p-4">
    <form method="POST" action="{{route('users.inventory.editar',$inventory->id)}}">
        @csrf
        @method('POST')
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="number" min="1" max="9000" step="1" class="form-control" id="inputEmail3" name="quantity" value="{{$inventory->quantity}}">
            </div>
        </div>
